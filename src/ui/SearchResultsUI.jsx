...
function SearchResultsUI({ query, isLoading, users, handleUserClick, goBack }) {
  return (
    <div className="mx-auto max-w-[90%] rounded-lg border border-gray-300 bg-gray-50 p-6 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:shadow-gray-900/50">
